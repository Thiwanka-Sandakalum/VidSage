...
from PyQt6.QtWidgets import (
    QWidget, QVBoxLayout, QHBoxLayout, QListWidget, QLabel, QPushButton, QTextEdit, QLineEdit, QSplitter, QGroupBox
)
...
class HistoryTab(QWidget):
    ...
    def _populate_history(self):
        # Find all *_info.json files in the CLI data directory
        data_dir = os.path.expanduser("~/Documents/learn/VidSage/Apps/cli/data")
        self.video_infos = []
    ...
    def _refresh_history_list(self, filter_text=""):
    ...
    def _on_history_selected(self, current, previous):
        ...
        # Thumbnail
        thumb_path = os.path.expanduser(f"~/Documents/learn/VidSage/Apps/cli/data/thumbnails/{info['id']}.jpg")
        ...
        # Summary
        summary_path = os.path.expanduser(f"~/Documents/learn/VidSage/Apps/cli/data/summaries/{info['id']}/{info['id']}_default.txt")
