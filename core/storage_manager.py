...
class StorageManager:
    ...
    def save_transcript(self, transcript_text: str, video_id: Optional[str] = None) -> Path:
        """
        Save transcript text for a video
    ...
    def save_vectorstore(self, vectorstore_obj: Any, video_id: Optional[str] = None) -> Path:
        """
        Save a vector store object for a video
        ...
        file_path = video_dir / f"{video_id}_vectorstore.pkl"
        with open(file_path, 'wb') as f:
